...
namespace Asp.Net_end_project.Areas.AdminArea.Controllers
{
    ...
    public class BrandController : Controller
    {
        ...
        {
            IEnumerable<Brand> brands = await _context.Brands.Where(m => !m.IsDeleted).AsNoTracking().ToListAsync();
            return View(brands);
        }
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            string path = Helper.GetFilePath(_env.WebRootPath, "assets/img/brand", brand.Image);
